...
const arr4 = [0,1]
const myarr4 = new Array(55,45,4)
console.log(myarr4);
...
// console.log(myArr.includes(9)); // to check if the number is present or not
// console.log(myArr.indexOf(3));        //// to check if the index  if the arrayy element

const newArr = myArr.join() // to convert entire string into array
